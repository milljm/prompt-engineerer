...
export function applySyntax(id: string, resolved: ResolvedTheme) {
  ...
  root.style.setProperty("--pe-hx-kw", pal.kw);
  root.style.setProperty("--pe-hx-st", pal.st);
  root.style.setProperty("--pe-hx-cm", pal.cm);
  root.style.setProperty("--pe-hx-nu", pal.nu);
  root.style.setProperty("--pe-hx-fn", pal.fn);
  root.style.setProperty("--pe-code-fg", pal.fg);
  root.style.setProperty("--pe-code", pal.bg);
